...
public class AccountTypeController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 500, message = "There Has Been An Internal Server Error", response = Response.class)})
    public ResponseEntity<Response<List<AccountTypeDto>>>getAll()
    {
        List<AccountTypeDto> accountTypes = fetchAccountTypeFlow.getAllAccountTypes();
        Response<List<AccountTypeDto>> response = new Response<>(true, accountTypes);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }

    @PostMapping("")
    @ApiOperation(value = "Creates a za.ac.nwu.ac.web.sb.new AccountType.", notes = "Creates a za.ac.nwu.ac.web.sb.new AccountType in DB.")
    @ApiResponses(value = {
            @ApiResponse(code = 201, message = "Success",response = Response.class),
            @ApiResponse(code = 400, message = "Bad Request",response = Response.class),
            @ApiResponse(code = 500, message = "Internal Server Error", response = Response.class)})
    public ResponseEntity<Response<AccountTypeDto>> create(@ApiParam(value = "Request body to create a za.ac.nwu.ac.web.sb.new AccountType",required = true) @RequestBody AccountTypeDto accountType)
    {
        AccountTypeDto accountTypeResponse = createAccountType.create(accountType);
        Response<AccountTypeDto> response = new Response<>(true,accountTypeResponse);
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 500, message = "Internal Server Error", response = Response.class)})
    public ResponseEntity<Response<AccountTypeDto>>getAccountType(
            ...
            @PathVariable("mnemonic") final String mnemonic)
    {
        ...
        Response<AccountTypeDto> response = new Response<>(true, accountType);
        return new ResponseEntity<>(response,HttpStatus.OK);
    }
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "AccountType Found", response = Response.class),
            @ApiResponse(code = 400, message = "Bad Request", response = Response.class),
            @ApiResponse(code = 404, message = "Resource not found", response = Response.class),
            @ApiResponse(code = 500, message = "Internal Server Error", response = Response.class)

    })
    public ResponseEntity<Response<AccountTypeDto>>deleteAccountType(
            @ApiParam(value = "The mnemonic that uniquely identifies the AccountType.",
                    example = "MILES",
                    name = "mnemonic",
                    required = true)
            @PathVariable("mnemonic") final  String mnemonic)
    {
        ...
        Response<AccountTypeDto> response = new Response<AccountTypeDto>(true, accountType);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
    ...
    public ResponseEntity<Response<AccountTypeDto>> updateAccountType(
            ...
            @ApiParam(value = "The za.ac.nwu.ac.web.sb.new AccountTypeName that the specified AccountType should be updated with.",
                    name = "newAccountTypeName",
                    required = true)
            @RequestParam("newAccountTypeName") final String newAccountTypeName,
            @ApiParam(value = "The optional za.ac.nwu.ac.web.sb.new date with to update the CreationDate is ISO date format(yyyy-mm-dd)if empty/null it will not update",
